...
function gotPoses(results){
  if(results.length > 0){
    ...
    console.log("rightwristX = "+rightwristX+" ,rightwristY = "+rightwristY+" ,rightwristSCORE = "+scoreRightWrist);
  }
}
...
if(pcscore ==4){
    ...
    stroke("white");
    textSize(25)
    text("Play the restart",width/2,height/2);
    text("Button to play again!",width/2,height/2+30)
    noLoop();
    pcscore = 0;
}
